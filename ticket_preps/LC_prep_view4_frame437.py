...
ticket.blur_path_CL = "{}/view4_frame437_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view4_frame437_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V4F437_top100_tiles_50kIt')
