...
ticket.blur_path_CL = "{}/view3_frame390_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view3_frame390_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V3F390_top100_tiles_50kIt')
