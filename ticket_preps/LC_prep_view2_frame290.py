...
ticket.blur_path_CL = "{}/view2_frame290_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view2_frame290_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V2F290_top100_tiles_50kIt')
