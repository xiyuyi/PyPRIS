...
ticket.blur_path_CL = "{}/view2_frame452_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view2_frame452_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V2F452_top100_tiles_50kIt')
