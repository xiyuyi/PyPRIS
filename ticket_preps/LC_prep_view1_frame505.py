...
ticket.blur_path_CL = "{}/view1_frame505_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view1_frame505_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V1F505_top100_tiles_50kIt')
