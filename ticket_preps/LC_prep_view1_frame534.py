...
ticket.blur_path_CL = "{}/view1_frame534_dif0CL.tif".format(ticket.datapath)
ticket.blur_path_diff1 = "{}/view1_frame534_dif1.tif".format(ticket.datapath)
...
ticket_folders = []
ticket_folders.append('PyPRIS_V1F534_top100_tiles_50kIt')
