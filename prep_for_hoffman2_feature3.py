...
ticket.datapath = '/u/scratch/x/xiyuyi/PyPRIS_data/S7_fov578_v4_set2_ox1155_oy1392'
...
ticket.init_ax0_range = list([-30, 40])
...
"output settings"
ticket.ticket_folder= 'PyPRIS_tickets_F3_set3_fov2'
