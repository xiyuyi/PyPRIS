...
class SingleCLTicket:
    def __init__(self):
        ...
        self.plane1_dz = np.int8(0)
        self.observer_edge_padding = True
        self.distortion_2_amp = np.nan
        self.distortion_2_shift = np.nan
        self.distortion_1_amp = np.nan
        self.distortion_1_shift = np.nan
...
class TwoColor_CL_and_grating_Ticket:
    def __init__(self):
        ...
        self.blur_path_diff1 = "{}/view4_frame328_dif1.tif".format(self.datapath)

        self.psf_path_CL_Crimson = "{}/PSF_Crimson_Order0.tif".format(self.datapath)
        self.distortion_Crimson_2_amp = np.nan
        self.distortion_Crimson_2_shift = np.nan
        self.distortion_Crimson_1_amp = np.nan
        self.distortion_Crimson_1_shift = np.nan

        self.psf_path_CL_Darkred = "{}/PSF_Darkred_Order0.tif".format(self.datapath)
        self.distortion_Darkred_2_amp = np.nan
        self.distortion_Darkred_2_shift = np.nan
        self.distortion_Darkred_1_amp = np.nan
        self.distortion_Darkred_1_shift = np.nan

        self.psf_path_diff1_Crimson = "{}/PSF_Crimson_Order1.tif".format(self.datapath)
        self.shift_Crimson_1 = np.nan
        self.shift_Crimson_2 = np.nan

        self.psf_path_diff1_Darkred = "{}/PSF_Darkred_Order1.tif".format(self.datapath)
        self.shift_Darkred_1 = np.nan
        self.shift_Darkred_2 = np.nan


        self.psf_norm_factor_Crimson = 80
        self.psf_norm_factor_Darkred = 80

        "specification of the psf stack"
        self.psfz0_Crimson = 101 # the count of the center plane, define it as z=0 in the psf coordinates system.
        self.psfz0_Darkred = 101 # the count of the center plane, define it as z=0 in the psf coordinates system.
        self.plane1_dz = np.int8(0)
        self.observer_edge_padding = True
